...
internal class ReportingSink(
    ...
    private var downstream = try {
        ...
        callDownstreamFailure(IOException("Failed to use file $downstreamFile by Pluto", e))
        null
    }
    ...
    override fun close() {
        ...
        isClosed = true
        safeCloseDownstream()
        callback.onSuccess(downstreamFile, totalByteCount)
    }
    ...
    interface Callback {
         ...
         */
        fun onSuccess(file: File?, sourceByteCount: Long)
