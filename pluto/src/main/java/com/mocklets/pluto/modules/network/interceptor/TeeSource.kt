/**
 * Source: chucker - https://github.com/ChuckerTeam/chucker/blob/develop/library/src/main/java/com/chuckerteam/chucker/internal/support/TeeSource.kt
 ...
 * to a [sideStream].
 */
internal class TeeSource(private val upstream: Source, private val sideStream: Sink) : Source {
