...
internal class ViewParser : IParser<View>() {
    ...
    override fun getTypeAttributes(view: View): List<Attribute<*>> {
        ...
        attributes.add(Attribute(AttributeType("layout_width", AttributeEditTag.LayoutWidth), LayoutParamDimens(params.width, view.width)))
        attributes.add(Attribute(AttributeType("layout_height", AttributeEditTag.LayoutHeight), LayoutParamDimens(params.height, view.height)))
        attributes.add(Attribute(AttributeTypeVisibility("visibility"), view.visibility))
        attributes.add(Attribute(AttributeTypeDimenDP("padding_left", AttributeEditTag.PaddingLeft), view.paddingLeft.toFloat()))
        attributes.add(Attribute(AttributeTypeDimenDP("padding_top", AttributeEditTag.PaddingTop), view.paddingTop.toFloat()))
        attributes.add(Attribute(AttributeTypeDimenDP("padding_right", AttributeEditTag.PaddingRight), view.paddingRight.toFloat()))
        attributes.add(Attribute(AttributeTypeDimenDP("padding_bottom", AttributeEditTag.PaddingBottom), view.paddingBottom.toFloat()))
        if (view.layoutParams != null && view.layoutParams is MarginLayoutParams) {
            ...
            attributes.add(Attribute(AttributeTypeDimenDP("margin_left", AttributeEditTag.MarginLeft), marginLayoutParams.leftMargin.toFloat()))
            attributes.add(Attribute(AttributeTypeDimenDP("margin_top", AttributeEditTag.MarginTop), marginLayoutParams.topMargin.toFloat()))
            attributes.add(Attribute(AttributeTypeDimenDP("margin_right", AttributeEditTag.MarginRight), marginLayoutParams.rightMargin.toFloat()))
            attributes.add(Attribute(AttributeTypeDimenDP("margin_bottom", AttributeEditTag.MarginBottom), marginLayoutParams.bottomMargin.toFloat()))
        }
        ...
        attributes.add(Attribute(AttributeType("alpha", AttributeEditTag.Alpha), view.alpha))
