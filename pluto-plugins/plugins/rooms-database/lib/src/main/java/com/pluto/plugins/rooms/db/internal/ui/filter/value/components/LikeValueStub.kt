...
internal class LikeValueStub(context: Context, column: ColumnModel) : BaseValueStub(context) {

    private val binding = PlutoRoomsStubFilterValueLikeBinding.inflate(LayoutInflater.from(context), this, true)
