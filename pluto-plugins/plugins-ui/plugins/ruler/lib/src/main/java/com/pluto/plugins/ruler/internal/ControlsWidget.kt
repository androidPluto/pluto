...
import com.pluto.plugins.ruler.com.pluto.plugins.ruler.internal.control.ControlCtaAdapter
import com.pluto.plugins.ruler.databinding.PlutoRulerControlsWidgetBinding
...
internal class ControlsWidget : ConstraintLayout {
    ...
    private val binding = PlutoRulerControlsWidgetBinding.inflate(LayoutInflater.from(context), this, true)
        ...
        binding.list.apply {
            ...
            addItemDecoration(
                DividerItemDecoration(context, LinearLayout.HORIZONTAL).apply {
                    setDrawable(ContextCompat.getDrawable(context, R.drawable.pluto_ruler___item_divider)!!)
                }
            )
        }
