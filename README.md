...
dependencies {
  ....
  debugImplementation 'com.plutolib:pluto:2.1.1'
  releaseImplementation 'com.plutolib:pluto-no-op:2.1.1'
  ....
}
```
...
dependencies {
  ....
  debugImplementation 'com.plutolib.plugins:bundle-core:2.1.1'
  releaseImplementation 'com.plutolib.plugins:bundle-core-no-op:2.1.1'
  ....
}
```
