...
internal class ResponseFragment : Fragment(R.layout.pluto_network___fragment_details_response) {

    private val binding by viewBinding(PlutoNetworkFragmentDetailsResponseBinding::bind)
