...
object QueryBuilder {
     ...
     * @return query
     */
    infix fun getColumnNames(table: String) = "PRAGMA table_info($table)"
     ...
     * @return query
     */
    infix fun getAllValues(table: String) = "SELECT * FROM $table"
     ...
     * @return query
     */
    infix fun dropTable(table: String) = "DROP TABLE $table"
     ...
     * @return query
     */
    infix fun deleteTable(table: String) = "DELETE FROM $table"
